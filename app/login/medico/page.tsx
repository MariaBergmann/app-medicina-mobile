          ...
          <Card className="border-green-100">
            <CardHeader className="text-center">
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <CardTitle className="text-xl text-primary">Login do Médico</CardTitle>
              </div>
              <CardDescription>Acesse sua conta para atender pacientes voluntariamente</CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="mt-6 text-center space-y-2">
                <p className="text-sm text-muted-foreground">
                  Não tem uma conta?{" "}
                  <Link href="/cadastro/medico" className="text-primary hover:underline font-medium">
                    Cadastre-se aqui
                  </Link>
                </p>
              </div>
